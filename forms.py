...
class SymptomsForm(FlaskForm):
    ...
    positive_symptoms_psychosis = SelectField('Positive Symptoms Psychosis', choices=[(-2,'Greatly Worsened Symptom'), (-2, 'Significantly Worsened Symptom'),(-1, 'Slightly Worsened Symptom'), (0, 'No effect'), (1, 'Slight Improvement in Symptom'), (2, 'Significant Improvement in Symptom'), (3, 'Great Improvement in Symptom')])
